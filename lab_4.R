...
# modularity value
wt_modularity <- vector(mode = 'numeric', length = 20)
for (s in 1:20) {
  set.seed(seed)
...
# Based on the modularity scores, the solution generated by the Louvain algorithm 
# on the weighted (undirected) graph is the best: 
friend_comm_Louvain_w
